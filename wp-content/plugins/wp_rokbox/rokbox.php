...
Description: RokBox 2.50.11 is a fully responsive modal plug-in for WordPress and the successor of RokBox1. Rewritten from the ground up it can display many different media formats such as images, videos, music, embedded widgets, Ajax content and WordPress widgets and takes advantage of the new technologies such as HTML5 and CSS3.
...
class RokBox {
	...
	function enqueue_mootools() {
		...
		if( !wp_script_is( 'mootools.js' ) && !wp_script_is( 'rok_mootools_js' ) ) {
